...
export declare const snapshotOptionChain: (get: IGet, underlyingAsset: string, query?: IOptionsChainQuery, options?: IRequestOptions) => Promise<IOptionsSnapshotChain>;
export declare const snapshotOptionContract: (get: IGet, underlyingAsset: string, optionContract: string, query?: IOptionsChainQuery, options?: IRequestOptions) => Promise<IOptionsSnapshotContract>;
